...
{/* first */}
      <div className="bg-gray-900 lg:m-12 m-7 lg:p-4 p-1 rounded-md shadow-lg shadow-white h-auto">
        ...
        <img  className="flex justify-center mx-auto rounded-md  shadow-lg shadow-yellow-500 mb-9" src="/Screenshot (33).png" width={700}/>
      </div>
  {/* second */}
  <div className="bg-gray-900 lg:m-12 m-7 lg:p-4 p-1 rounded-lg shadow-md shadow-white">
      ...
      {/* third */}
      <div className="bg-gray-900 lg:m-12 m-7 lg:p-4 p-1 rounded-md shadow-lg shadow-white">
        <h1 className="pt-3 mb-8">Demo Website</h1>
        <p className="lg:text-2xl lg:block hidden mb-4">From responsive design to intuitive navigation, we aim to make your browsing experience seamless. Whether you're on a desktop, tablet, or mobile device, our website adapts to ensure optimal viewing.</p>
